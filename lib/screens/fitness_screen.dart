...
class FitnessScreen extends StatelessWidget {
  ...
  // Filter posts to include only those with categoryId '4' (Fitness)
  static final List<LatestPost> posts = latestPosts.where((post) => post.categoryId == '4').toList();
  ...
  Widget _buildPostList(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        mainAxisAlignment: MainAxisAlignment.start,
        children: [
          // Add the "Fitness" title at the top
          Padding(
